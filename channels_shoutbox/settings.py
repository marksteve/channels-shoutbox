"""
Django settings for channels_shoutbox project.
...
SECRET_KEY = 'bcy3p=9q@4f4m%k6(&w(y(@m^jd(ll)fd^(x^$f1ly0ju62%*g'
...
ROOT_URLCONF = 'channels_shoutbox.urls'
...
WSGI_APPLICATION = 'channels_shoutbox.wsgi.application'
